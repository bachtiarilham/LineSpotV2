package com.epy.linespotv2.data.repository_impl.subscription

import com.epy.linespotv2.core.network.ApiCondition
import com.epy.linespotv2.core.utils.Dispatcher
import com.epy.linespotv2.data.remote.api.ApiService
import com.epy.linespotv2.data.remote.mapper.subscription.toDomain
...
class SubscribeRepositoryImpl @Inject constructor(
    ...
    override suspend fun getSubscriptionPage(): Flow<ApiCondition<SubscribeResponseModel>> = flow {
        emit(ApiCondition.AppLoading)

        try {
            val response = api.getSubscriptionPage()
